    ...
    >
      <div>
        <p class="text-[#adb7be]">
          ...
          from you! Whether it's about building a dynamic web application,
          exploring innovative solutions, or collaborating on something
          exciting, feel free to get in touch. Let’s create something amazing
          together!
        </p>
        <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
          ...
          <div class="flex mb-10 items-center">
            ...
            <div class="ml-5 text-white">
              ...
              <p>
                <a
                  href="https://www.linkedin.com/in/faizal-mahmood/"
                  target="_blank"
                  >linkedin.com/in/faizal-mahmood/</a
                >
              </p>
            </div>
          </div>
...
const sendEmail = () => {
  ...
  // Construct the mailto URL with form values
  const mailtoLink = `mailto:faizaldnb@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
    `Message from: ${email}\n\n${message}`,
  )}`;
