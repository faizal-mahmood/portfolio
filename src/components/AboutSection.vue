    ...
    >
      ...
      >
        ...
        <p class="text-base lg:text-lg mt-8 py-8">
          ...
          seamless digital experiences, I’ve worked on diverse projects that
          blend creativity with functionality. My expertise spans developing
          efficient, user-focused applications and architecting scalable backend
          systems. When I’m not coding, I enjoy exploring emerging tech trends
          and finding innovative ways to solve complex challenges.
        </p>
