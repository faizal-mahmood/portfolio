...
const services = ref([
  {
    ...
    description:
      "Responsive and dynamic web applications using Python, Django, Java, Spring Boot, Vue.js and AWS!",
  },
  {
    id: 2,
    ...
    description:
      "Responsive and dynamic frontend solutions using HTML, CSS, JavaScript, Vue.js, Angular, Vuetify and PrimeVue!",
  },
  {
    id: 3,
    ...
    description:
      "Scalable and robust backend solutions using Python, Django, Java, Spring Boot and AWS!",
  },
]);
</script>
